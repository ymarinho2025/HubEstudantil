# Deploy independente na Vercel — GameHub
...
## Deploy
Defina esta pasta (GameHub) como a raiz do projeto na Vercel. O vercel.json usa uma única função PHP em api/index.php (runtime vercel-php@0.9.0) para evitar o limite de múltiplas Serverless Functions do plano Hobby.
